		...
		<div class="uk-position-relative uk-visible-toggle uk-light uk-box-shadow-small uk-overflow-hidden uk-border-rounded"
		 tabindex="-1" data-uk-slider="autoplay: true">
			<ul class="uk-slider-items uk-child-width-1-1">
				<li>
					<img src="{{('Front2/img/2.jpg')}}" alt="Slide">
					<div class="uk-position-cover uk-overlay-light uk-flex uk-flex-middle uk-padding-slide">
						<div class="uk-width-3-4@m">
							<h2 class="uk-heading-medium uk-letter-spacing-medium">Audio & Video transcribed in Minutes</h2>
							<p>

                <a href="#" class="uk-button uk-button-primary-preserve uk-button- ">Get started for $0.5 Per Minute</a>
							</p>
						</div>
					</div>
				</li>
				<li>
					<img src="{{('Front2/img/1.jpg')}}" alt="Slide">
					<div class="uk-position-cover uk-overlay-xlight uk-flex uk-flex-middle uk-padding-slide">
						<div class="uk-width-1-2@m">
							<h1 class="uk-heading-medium uk-letter-spacing-medium">Precise human transcription capability </h1>
							<p>
								<a class="hvr-forward" href="course.html" data-uk-icon="icon: arrow-right">Our team constitutes skilled, precise trasncriber who deliver in minutes</a>
							</p>
						</div>
					</div>
				</li>
				...
				<div class="uk-flex uk-flex-middle">
					<div class="uk-grid-small" data-uk-grid>
						...
						<div class="uk-width-expand">
							<h4 class="uk-margin-remove">Create an account with us</h4>
							<p class="uk-margin-remove uk-text-muted uk-text-small">Free for clients and transcribers</p>
						</div>
					</div>
				</div>
				<div class="uk-flex uk-flex-middle">
					<div class="uk-grid-small" data-uk-grid>
						...
						<div class="uk-width-expand">
							<h4 class="uk-margin-remove">Upload single or batch A/V files</h4>
							<p class="uk-margin-remove uk-text-muted uk-text-small">Fast and Easy</p>
						</div>
					</div>
				</div>
				<div class="uk-flex uk-flex-middle">
					<div class="uk-grid-small" data-uk-grid>
						...
						<div class="uk-width-expand">
							<h4 class="uk-margin-remove">Checkout and stay tuned</h4>
							<p class="uk-margin-remove uk-text-muted uk-text-small">Cheap, convenient and reliable</p>
						</div>
					</div>
				</div>
			</div>
...
<div class="uk-section uk-margin-top">
  <div class="uk-container">
    ...
    <div class="uk-text-center uk-margin-large-top">
      <div class="uk-text-primary"><span class="uk-margin-small-right"><img src="{{('Front2/img/loader.svg')}}" alt="Loader" width="22" height="22" data-uk-svg></span> Loading More</div>
    </div>    
  </div>
</div>
