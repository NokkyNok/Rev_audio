                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                            ...
                            <div class="detials">
                                <p>All orders</p>
                                <a href="#">
                                    <h4>Click view order to see details</h4>
                                </a>
                            </div>
                        </div>
                ...
                <div class="comments-area">
                        ...
                        <div class="comment-list">
                            <div class="single-comment justify-content-between d-flex">
                                ...
                                <div class="reply-btn">
                                    <button class="btn btn-primary btn-sm">{{$order->status}}</button>
                                    <a href="{{route('client_order_details',$order->id)}}" class="btn-reply mt-2">View Order</a>
                                </div>
                            </div>
                        </div>
                        @endforeach
