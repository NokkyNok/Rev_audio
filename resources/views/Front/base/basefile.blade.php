...
<html lang="en">
  <head>
    ...
    <title>Video audio Convert</title>
    <!-- Bootstrap CSS -->
    ...
    <link rel="stylesheet" href="{% static 'Front/fontawesome-free/css/all.min.css' %}">
    <!-- main css -->
              ...
              <ul class="nav navbar-nav menu_nav ml-auto">
                ...
                <li class="nav-item submenu dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li class="nav-item">
                      <a class="nav-link" href="courses.html">Videos Converted</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" href="elements.html">Audio</a>
                    </li>
                  </ul>
                </li>
                <li class="nav-item submenu dropdown">
